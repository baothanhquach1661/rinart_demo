	            ...
	            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
	                ...
	                <div class="page-title-right">
	                    <ol class="breadcrumb m-0">
	                        ...
	                        <li class="breadcrumb-item active">Update {{ $divisions->division_area_name }}</li>
	                    </ol>
	                </div>
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.division.update', $divisions->id) }}">
                            @csrf
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" name="division_area_name" value="{{ $divisions->division_area_name }}" type="text" required>
                                </div>
