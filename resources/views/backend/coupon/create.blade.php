	            ...
	            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
	                ...
	                <div class="page-title-right">
	                    <ol class="breadcrumb m-0">
	                        ...
	                        <li class="breadcrumb-item active">Create a new coupon</li>
	                    </ol>
	                </div>
                        ...
                        <form method="post" action="{{ route('admin.coupon.store') }}">
                            ...
                            <div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="coupon_detail"></textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" name="discount_percentage" type="text">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" name="discount_regular" type="text">
                                </div>

                                <label for="">Validity</label>
                                <div class="mb-4">

                                    <input style="width: 50%;" type="date" name="coupon_validity" class="form-control" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}">
                                </div>
